...
<html class="no-js"> 
    ...
    <body style="position: relative;">
                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar">
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 40px;">
                                ...
                                <li><a onclick="div_show()" title="Create Album"><img src="/bootstrap/albumadd.png" height="7px" width="30px"></a></li>
        ...
        <div class="container gallery" >
            <div id="abc1" style="overflow:scroll;">
                <div id="popupContact">
            ...
            <form name="checkbox" action="addphotos.php" method="post" class="uniForm">
                <div padding="10px" id="google" style="display:none; position: fixed; z-index: 13; width: 25%;float: bottom; height: 60px; background-color: #ffffff;opacity: 95%;">
                    <table>
                        <tr>
                            <td>
                                <label id="subscribe_email">
                                    <select name="albumselect" style="vertical-align: middle;display: inline-block;">
                <?php  
                ...
                ?>
                            ...
                            <td> 
                                <input type="image" src="/bootstrap/Button.png" float="right" alt="Submit" height="28px" width="28px" id="subscribe_submit"/>
                            </td>
                            <td> 
                                <a onclick="div_show()" title="Create Album"><img src="/albumadd.png"  id="subscribe_submit"></a>
                            </td>
                        </tr>
                    </table>
                </div>
                            ...
                            <div class="col-md-3">
                                <div class="roundedTwo"> 
                                    <a id="id<?php echo $count;?>" href="<?php echo $photo_path;?>" rel="lightbox[group]" >
                                        <img margin="0" class="borders"src="<?php echo $path;?>" title="<?php echo $filename;?>" id="ids<?php echo $count;?>"/>
                                    </a>
                                    <input type="checkbox"  id="roundedTwo<?php echo $count;?>" name="check[]" value="<?php echo $value['System_Filename'];?>" onclick="changeborder('ids<?php echo $count;?>');"/>
